...
export const MobileComponent = () => {
  ...
  const googlePlayStoreUrl =
    "https://play.google.com/store/apps/details?id=com.netflix.mediaclient&hl=nl&gl=US";
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        >
          <Typography variant="h2">Zwangere Guy</Typography>
          <Button
            variant="contained"
            color={"warning"}
            sx={{
          ...
          <Stack spacing={6}>
            <img
              ...
              style={{ borderRadius: "25px", width: "300px", height: "100px" }}
            />
            <img
              src="https://lh3.googleusercontent.com/xFSzp1mzvcvFVtHhNDxSslvaVX9P4y-HWZfA0RKo3NNOUDSbw7kuZOqaaxSICXftrUEP4aLhqtYzGMBO2uWyGWjfB6Zm-qJztfGvtyMVP8Hqi-hPJQYB=w1000-e365"
              alt="Google play store button"
              onClick={() => window.open(googlePlayStoreUrl)}
              style={{ borderRadius: "25px", width: "300px", height: "100px" }}
            />
          </Stack>
        </Stack>
